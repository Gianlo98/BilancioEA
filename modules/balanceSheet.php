...
<?php 
    require(dirname(__FILE__) . "/../utils/core/Statement/balanceSheetManager.php");
    ...
    <div id="banceSheetContainer">
        <div class="col-md-6">
            <table class="table table-striped table-hover ">
                <thead>
                    <h1 class="balanceSheetSectionTitle">Attivo</h1>
                </thead>
                <tbody>
                    <?php
                        $balanceSheetManager->printBalanceSheetActive();
                    ?>
                </tbody>
            </table>
        </div>
        <div class="col-md-6">
            <table class="table table-striped table-hover ">
                                <thead>
                    <h1 class="balanceSheetSectionTitle">Passivo</h1>
                </thead>
                <tbody>
                    <?php
                        $balanceSheetManager->printBalanceSheetPassive();
                    ?>
                </tbody>
            </table>
        </div>
