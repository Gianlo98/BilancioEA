...
<?php 
    require(dirname(__FILE__) . "/../utils/core/Statement/reworkedBalanceSheetManager.php");
    $reworkedBalanceSheetManager = new ReworkedBalanceSheetManager(true);
?>
    ...
    <div id="banceSheetContainer">
        <div class="col-md-6">
            <table class="table table-striped table-hover ">
                <thead>
                    <h1 class="balanceSheetSectionTitle">Impieghi</h1>
                </thead>
                <tbody>
                    <?php
                        $reworkedBalanceSheetManager->printReworkedBalanceSheetInvestments();
                    ?>
                </tbody>
            </table>
        </div>
        <div class="col-md-6">
            <table class="table table-striped table-hover ">
                                <thead>
                    <h1 class="balanceSheetSectionTitle">Fonti Di Finanziamento</h1>
                </thead>
                <tbody>
                    <?php
                        $reworkedBalanceSheetManager->printReworkedBalanceSheetSOF(); //sources of funding 
                    ?>
                </tbody>
            </table>
        </div>
